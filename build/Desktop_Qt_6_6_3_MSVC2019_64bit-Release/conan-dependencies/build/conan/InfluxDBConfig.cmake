...
set(InfluxDB_INCLUDE_DIRS ${influxdb-cxx_INCLUDE_DIRS_RELEASE} )
set(InfluxDB_INCLUDE_DIR ${influxdb-cxx_INCLUDE_DIRS_RELEASE} )
set(InfluxDB_LIBRARIES ${influxdb-cxx_LIBRARIES_RELEASE} )
set(InfluxDB_DEFINITIONS ${influxdb-cxx_DEFINITIONS_RELEASE} )


# Only the last installed configuration BUILD_MODULES are included to avoid the collision
foreach(_BUILD_MODULE ${influxdb-cxx_BUILD_MODULES_PATHS_RELEASE} )
